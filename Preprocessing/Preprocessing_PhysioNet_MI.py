...
root_dir = '......./Data/Physionet_MI/physionet.org/files/eegmmidb/1.0.0'
files = [file for file in os.listdir(root_dir) if file.startswith("S0") or file.startswith("S1")]
files = sorted(files)
...
db = lmdb.open('......./Data/Physionet_MI/processed_average', map_size=4614542346)
