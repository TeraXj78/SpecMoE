...
root_dir = '......./Data/SEED_V/SEED_V'
files = [file for file in os.listdir(root_dir) if file.endswith(".cnt")]
files = sorted(files)
"""
files = ['6_3_20180802.cnt',
 '7_1_20180411.cnt',
 '7_1_20180411_repaired.cnt',
 '7_2_20180418.cnt']
files = [
 '7_1_20180411_repaired.cnt',
 '7_2_20180418.cnt']
...
db = lmdb.open('......./Data/SEED_V/processed', map_size=15614542346)
...
#with open('......./Data/SEED_V/processed/training_labels.pkl', "wb") as f:
