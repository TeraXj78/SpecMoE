...
edf_path   = "......./Data/haaglanden-medisch-centrum-sleep-staging-database-1.2/haaglanden-medisch-centrum-sleep-staging-database-1.1/recordings" #'path/to/edf/recordings'
csv_folder = "......./Data/haaglanden-medisch-centrum-sleep-staging-database-1.2/haaglanden-medisch-centrum-sleep-staging-database-1.1/recordings/" #'path/to/csv/recordings/'
output_path = "......./Data/HMC_processed_pkl_256Hz/" 
...
for idx, file in enumerate(edf_files):
    ...
    csv_path = csv_folder + file_name + '_sleepscoring.txt' #'_sleepscoring.csv'
    try:
    ...
    annotation_df = pd.read_csv(csv_path, sep =",", skipinitialspace=True)
