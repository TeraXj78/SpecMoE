...
def preprocessing_recording(file_path, file_key_list: list, db: lmdb.open):
    ...
    try:
        ...
        print("\n\n\n\n@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
        print(f"[SKIP] read_raw_edf failed: {file_path} -> {repr(e)}")
        print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n\n\n\n")
        return
    ...
    print(f"eeg_array : {eeg_array.shape}")
    print("*******************************")
...
if __name__ == '__main__':
    ...
    file_path_list = iter_files('......./Data/TUEG/edf/')
    ...
    db = lmdb.open(r'......./Data/TUEG/Database_TUEG_v2/', map_size=1649267441664)
    ...
    print(f"Processing Time = {(end-start)/60} mn")
